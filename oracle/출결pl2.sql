...
select * from vwTeacherOpenCourseList;
...
SELECT count(*) FROM vwstudentattend;
...
BEGIN
    ...
    SELECT count(*) INTO vtnum FROM vwTeacherCourse WHERE teacherId = ptid AND pdate BETWEEN startDate AND endDate;     
    SELECT count(*) INTO vdnum FROM vwTeacherCourse WHERE pdate BETWEEN startDate AND endDate;
...
BEGIN
    procTeacherDateAttendance(4, '2023-07-20');
END;
/
