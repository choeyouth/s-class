...
public class memberInfo_dml {
    ...
    public static void main(String[] args) {
        ...
        // 데이터 삽입 SQL 쿼리
        String insertQuery = "INSERT INTO tblMemberInfo (seq, member_seq, name, address, tel, email) "
                		   + "VALUES (memberInfo_seq.NEXTVAL, 1, '홍길동', '서울시 강남구 테헤란로', '010-1234-5678', 'rlfehd@naver.com')";
